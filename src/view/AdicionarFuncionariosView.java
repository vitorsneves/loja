...
public class AdicionarFuncionariosView extends JFrame {
	...
	public JPasswordField getTextConfirmarSenha() {
		return TextConfirmarSenha;
	}

	public void setTextConfirmarSenha(JPasswordField textConfirmarSenha) {
		TextConfirmarSenha = textConfirmarSenha;
	}
